...
const About: NextPage = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      ...
      <h2 className="font-body text-white text-center font-bold pt-2 text-base sm:text-xl md:text-2xl duration-500 sm:pt-4">
        フロントエンドエンジニア
      </h2>
      <div className="font-body w-10/12 mx-auto text-white mt-7 md:mt-9 text-sm duration-500 max-w-4xl sm:mt-9 md:text-lg lg:text-xl">
